...
<c:if test="${erreur != null }">
	<H2 style="color: red"" role="alert">
  		<c:out value=" ${erreur} "></c:out>
            ...
            <div class="row mt">
          <div class="col-lg-12">
            <h4><i class="fa fa-angle-right"></i>Einen Fleck hinzufügen</h4>
              ...
              <div class=" form">
                <form class="cmxform form-horizontal style-form" method="post" action="ajoutTache">
                  ...
                  <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <select  name="id_doc" type="text" class="form-control" required>
    				    ...
    				    <option val="${ dossier.id_doc}">${ dossier.id_doc}</option>
						</c:forEach>
   					 </select>
                    </div>
                  </div> 
                  ...
                  <div class="col-md-4">
                    ...
                    <span class="help-block">Wählen Sie einen Zeitraum aus.</span>
                  </div>
                </div>
                  <div class="form-group">
