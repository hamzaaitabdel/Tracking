            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="signup-card card-block auth-body mr-auto ml-auto">
                        <form class="md-float-material" id="commentForm" method="post" action="editDoc">
                            ...
                            <div class="auth-box">
                                <div class="row m-b-20">
                                    <div class="col-md-12">
                                        <h3 class="text-center txt-primary">Modifier le dossier numero: ${ dossier.id_doc}</h3>
                                    </div>
                                </div>
                                <hr/>
                                <div class="input-group">
                                    
                                    <input type="text" class="form-control"name="id_doc" readonly="" value="${ dossier.id_doc}">
                                    <span class="md-line"></span>
                                </div>
                                <div class="input-group">
                                    <input type="text" class="form-control"name="nom_cl" placeholder="nom client" value="${ dossier.nom_cl}">
                                    <span class="md-line"></span>
                                </div>
                                <div class="input-group">
                                    <input type="text" class="form-control"name="type" placeholder="type file" value="${ dossier.type}">
                                    <span class="md-line"></span>
                                </div>
